        ...
        return(
            <div>
                <section className="encabezado-formas-de-pago">                    
                         ...
                         <h1 className="titulo">Viaja ya</h1>             
                
                </section>
                <section className="row container " >
                    <div className="explicacion-de-pago col s12 l12 ">
                        <div className="textos">
                            <h4>“Tenemos vacaciones relámpago, esa fecha especial es en menos de 1 mes y queremos 
                                celebrarlo como se debe en un sitio especial junto a todos nuestros seres queridos, 
                                pero no tenemos el dinero para pagarlo en estos momentos...”
                            </h4>
                    ...
                    <div className="solucion">
                            <p>
                            No se preocupe, con On Vacation, usted puede viajar YA y pagar despues...
                            </p>
                    </div>                
                ...
                <section>
                    <h2 className="container">Cuales son las condiciones del prestamo 
                        ...
                        <div className="textos">
                           <ol>
                            <li>Valor máximo que se presta: $4.000.000 o el 100% del valor total de la reserva</li>
                            <li>Prestamo a máximo 24 meses</li>
