...
class SanAndres extends React.Component {
    render() {

        let divStyle = {backgroundImage: `url(${datosDestino[1].imagen})`}
        return(
            ...
            <React.Fragment>
                ...
                <div className="hero " style = {divStyle} >
                        ...
                        <div className = "row">
                            ...
                            <h1 className = "titulo ">{datosDestino[1].nombre}</h1>
                            <h3 className= "subtitulo">{datosDestino[1].slogan}</h3>
                            </div>
                        </div>
                ...
                <div className="row intro">                    
                    <div className="playa-del-carmen-texto z-depth-4"><p>
                        {datosDestino[1].descripcion}</p>
                        
                        <div className = "mexico">
                            <a href = {datosDestino[1].link_externo} target = "blank">
                            <img src = {datosDestino[1].imagen_link_externo}/>
                            <p className = "mexico-hijo">{datosDestino[1].texto_link_externo}</p>
                            </a>
                        </div>
                    ...
                    <div>
                        ...
                        <div className="">                        
                            ...
                            <iframe width="auto" height ="auto"  src={datosDestino[1].video} frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen= {true}></iframe>
                    
                        </div>
                    </div>    
                    <h4>¿Donde queda {datosDestino[1].nombre}?</h4>
                    <div className ="mapa-container">
                        <iframe className="google-map" src={datosDestino[1].ubicacion} frameBorder="0" allowFullScreen></iframe>
                ...
                <div className= "hoteles">
                    ...
                    <Paseos datos = {datosPaseos.SanAndres}/>
